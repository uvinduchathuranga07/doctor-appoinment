...
class FeatureController extends Controller
{
    ...
    {
        return Inertia::render('VehicleCMS/VehicleFeature/Index');
    }
    ...
    {
        return Inertia::render('VehicleCMS/VehicleFeature/CreateUpdate');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vehicle.feature');
    ...
    {
        $vehicle_feature = Feature::find($id);
        // dd($vehicle_feature);
        return Inertia::render('VehicleCMS/VehicleFeature/CreateUpdate', ['vehicle_feature'=>$vehicle_feature]);
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            DB::beginTransaction();
            $vehicle_feature = Feature::find($request->id);
            $vehicle_feature->name = $request->name;
            $vehicle_feature->status = $request->status;
