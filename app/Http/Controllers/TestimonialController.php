...
class TestimonialController extends Controller
{
    ...
    {
        return Inertia::render('OtherCMS/Testimonials/Index');
    }
    ...
    {
        return Inertia::render('OtherCMS/Testimonials/CreateUpdate');
    }
    ...
    public function getData()
    {
        ...
        return DataTables::of($users)
            ...
            ->rawColumns(['check', 'name', 'status', 'action', 'image' ])
            ->make(true);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                $testimonial->addMedia($request->file('image'))->toMediaCollection('Vehicle_testimonial_image');
                $testimonial->save();
            }
    ...
    public function edit($id)
    {
        ...
        // dd($testimonial);
        return Inertia::render('OtherCMS/Testimonials/CreateUpdate', ['testimonial' => $testimonial]);
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('vehicle_testimonial_image')) {
                if ( $testimonial->media) {
                    Storage::disk('public')->delete( $testimonial->media);
                     $testimonial->clearMediaCollection('vehicle_testimonial_image');
                }
                 $testimonial->addMedia($request->file('vehicle_testimonial_image'))->toMediaCollection('vehicle_testimonial_image');
                 $testimonial->save();
            }
