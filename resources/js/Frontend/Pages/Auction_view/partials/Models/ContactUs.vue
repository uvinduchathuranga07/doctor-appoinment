<template>
    <section class="container mt-5">
        <form class="row g-3" @submit.prevent="submitEnquiry">
            <div class="col-md-6">
                <input type="text" class="form-control" v-model="form.vehicle_name" disabled>
            </div>
            <div class="col-md-6">
...
export default {
    ...
    data() {
        return {
            form: useForm({
                vehicle_name: this.$page.props.details.MARKA_NAME + " " + this.$page.props.details.MODEL_NAME + " " + this.$page.props.details.COLOR,
                vehicle_url: route('auction', { model: this.$root.stringToSlug(this.$page.props.details.MARKA_NAME), slug: this.$root.stringToSlug(this.$page.props.details.MARKA_NAME) + '-' + this.$root.stringToSlug(this.$page.props.details.MODEL_NAME), id: this.$page.props.details.ID }),
                vehicle_id: this.$page.props.details.ID,
                stock_type: "auction",
                name: "",
                email: "",
                mobile: "",
