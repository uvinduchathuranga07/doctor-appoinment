...
<template>
    <div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Bewaxed, the software program provided by the Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Bewaxed.</p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="https://bewaxed.lk/contact-us/"
                    rel="external nofollow noopener" target="_blank">https://bewaxed.lk/contact-us/</a></li>
        </ul>
    </div>
</template>
