        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <data-table ref="datatable" :url="route('product.getdata')" :columns="columns"
                            :columnDefs="columnDefs" id="mytable">
                            <template #header>
                                <tr>
                                    <th width="10%">
...
export default {
    ...
    methods: {
        ...
        deleteSelectedItems() {
            this.form.ids = this.selectedRows
            this.form.post(route("product.delete"), {
                onSuccess: () => {
                    $("#deleteConfirm").modal("hide")
                    this.resetForm()
                    this.reloadTable()
                    this.$root.showMessage("success", "Deleted successfully.")
                },
                onError: () => {
                    this.$root.showMessage("error", "Error deleting products.")
                }
            })
        },
        resetForm() {
